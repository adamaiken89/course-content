...
```mermaid
mindmap
  root((Full-Stack Framework Next.js App Router))
...
> **Predict**: Commit to an answer: does full-stack framework — next.js app router get simpler or harder once ref enters the picture?
>
...
> **Think**: Could you implement full-stack framework — next.js app router without **ref**? What would the cost be?
>
> *Answer: Yes, but you'd hand-roll what **ref** already handles — more code, more edge cases, fewer guarantees.*
> **Cloze**: {blank} governs how full-stack framework — next.js app router behaves when multiple forwardref concerns collide.
> **Cloze**: The rule that keeps ref correct under load is called {blank}.
> **Cloze**: In full-stack framework — next.js app router, app router determines {blank}.
> **Spot the Mistake**: Code review note: someone applies forwardref everywhere "to be safe" in a full-stack framework — next.js app router codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need forwardref. Apply it where the semantics demand it, and document why.*
