...
```mermaid
mindmap
  root((Image Optimization next image & Sharp))
...
> **Predict**: Commit to an answer: does image optimization — next/image & sharp get simpler or harder once priority enters the picture?
>
...
> **Think**: Could you implement image optimization — next/image & sharp without **priority**? What would the cost be?
>
> *Answer: Yes, but you'd hand-roll what **priority** already handles — more code, more edge cases, fewer guarantees.*
> **Cloze**: {blank} governs how image optimization — next/image & sharp behaves when multiple <link rel="preload"> concerns collide.
> **Cloze**: The rule that keeps priority correct under load is called {blank}.
> **Cloze**: In image optimization — next/image & sharp, loading determines {blank}.
> **Spot the Mistake**: Code review note: someone applies <link rel="preload"> everywhere "to be safe" in a image optimization — next/image & sharp codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need <link rel="preload">. Apply it where the semantics demand it, and document why.*
