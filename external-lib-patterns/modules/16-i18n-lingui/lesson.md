...
```mermaid
mindmap
  root((Internationalization Lingui))
...
> **Predict**: Commit to an answer: does internationalization — lingui get simpler or harder once <trans> enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies i18n._(msg\ everywhere "to be safe" in a internationalization — lingui codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need i18n._(msg\. Apply it where the semantics demand it, and document why.*
