...
```mermaid
mindmap
  root((Form Libraries Formio & React Hook Form))
    Two Form Paradigms
...
> **Predict**: Commit to an answer: does form libraries — formio & react hook form get simpler or harder once useform enters the picture?
>
...
> **Cloze**: {blank} governs how form libraries — formio & react hook form behaves when multiple controller concerns collide.
> **Cloze**: The rule that keeps useform correct under load is called {blank}.
> **Cloze**: In form libraries — formio & react hook form, resolver: zodresolver(schema) determines {blank}.
> **Spot the Mistake**: Code review note: someone applies controller everywhere "to be safe" in a form libraries — formio & react hook form codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need controller. Apply it where the semantics demand it, and document why.*
