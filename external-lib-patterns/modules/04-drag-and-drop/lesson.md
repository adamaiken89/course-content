...
> **Predict**: Commit to an answer: does drag & drop — dnd-kit get simpler or harder once dndcontext enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies usedraggable everywhere "to be safe" in a drag & drop — dnd-kit codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need usedraggable. Apply it where the semantics demand it, and document why.*
