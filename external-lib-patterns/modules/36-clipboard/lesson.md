...
> **Predict**: Commit to an answer: does clipboard utilities get simpler or harder once navigator.clipboard enters the picture?
>
...
> **Think**: Could you implement clipboard utilities without **navigator.clipboard**? What would the cost be?
>
> *Answer: Yes, but you'd hand-roll what **navigator.clipboard** already handles — more code, more edge cases, fewer guarantees.*
> **Cloze**: {blank} governs how clipboard utilities behaves when multiple click concerns collide.
> **Cloze**: The rule that keeps navigator.clipboard correct under load is called {blank}.
> **Cloze**: In clipboard utilities, keydown determines {blank}.
> **Spot the Mistake**: Code review note: someone applies click everywhere "to be safe" in a clipboard utilities codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need click. Apply it where the semantics demand it, and document why.*
