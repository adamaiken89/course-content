...
```mermaid
mindmap
  root((Virtual Scrolling TanStack Virtual))
...
> **Predict**: Commit to an answer: does virtual scrolling — tanstack virtual get simpler or harder once getvirtualitems() enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies virtualitem[] everywhere "to be safe" in a virtual scrolling — tanstack virtual codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need virtualitem[]. Apply it where the semantics demand it, and document why.*
