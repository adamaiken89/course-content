...
> **Predict**: Before reading deeper: what do you expect happens when __typename:id interacts with user:123 in graphql — apollo client?
>
> *Answer: The system relies on __typename:id to keep user:123 predictable — when both apply, the stricter rule wins.*
> **Spot the Mistake**: A developer treats __typename:id as optional because "it works without it." Where is the mistake?
>
> *Answer: It works only until the assumptions behind __typename:id are violated. The fix: treat it as part of the contract of graphql — apollo client, not an optimization.*
