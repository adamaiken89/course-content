...
> **Predict**: Commit to an answer: does file upload — uppy get simpler or harder once @uppy/core enters the picture?
>
...
> **Cloze**: {blank} governs how file upload — uppy behaves when multiple @uppy/dashboard concerns collide.
> **Cloze**: The rule that keeps @uppy/core correct under load is called {blank}.
> **Cloze**: In file upload — uppy, @uppy/tus determines {blank}.
> **Spot the Mistake**: Code review note: someone applies @uppy/dashboard everywhere "to be safe" in a file upload — uppy codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need @uppy/dashboard. Apply it where the semantics demand it, and document why.*
