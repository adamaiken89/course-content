...
```mermaid
mindmap
  root((Markdown Rendering react-markdown))
...
> **Predict**: Commit to an answer: does markdown rendering — react-markdown get simpler or harder once \| a \| b \| enters the picture?
>
...
> **Cloze**: {blank} governs how markdown rendering — react-markdown behaves when multiple ~~text~~ concerns collide.
> **Cloze**: The rule that keeps \| a \| b \| correct under load is called {blank}.
> **Cloze**: In markdown rendering — react-markdown, - [x] done determines {blank}.
> **Spot the Mistake**: Code review note: someone applies ~~text~~ everywhere "to be safe" in a markdown rendering — react-markdown codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need ~~text~~. Apply it where the semantics demand it, and document why.*
