...
```mermaid
flowchart LR
    U[Uptrend<br/>HH + HL] --> BUY[Buy pullbacks<br/>ride momentum]
    D[Downtrend<br/>LH + LL] --> SELL[Sell bounces<br/>or short]
    S[Sideways<br/>Range] --> R[Trade range<br/>buy support / sell resistance]
    style U fill:#5c8a6a,stroke:#333
    style D fill:#b86a4a,stroke:#333
    style S fill:#b8924a,stroke:#333
    style BUY fill:#5c8a6a,stroke:#333
    style SELL fill:#b86a4a,stroke:#333
...
```mermaid
flowchart LR
    S[Support Level] --> B1[Bounce<br/>buyers step in]
    S --> BR[Break below<br/>support]
    BR --> RR[Now = New Resistance]
    R[Resistance Level] --> B2[Reject<br/>sellers step in]
    R --> RB[Break above<br/>resistance]
    RB --> RR2[Now = New Support]
    style S fill:#5c7a99,stroke:#333
    style R fill:#b8924a,stroke:#333
    style RR fill:#b86a4a,stroke:#333
    style RR2 fill:#5c8a6a,stroke:#333
```
