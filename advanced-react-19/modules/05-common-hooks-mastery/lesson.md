...
```mermaid
mindmap
  root((Common Hooks Mastery useCallback useMemo useRef useImpe))
    ...
    React Compiler What It Auto-Memoizes and What It Doesnt
    Example 1 Optimizing a Data Grid with Conditional Memoi
    Example 2 Imperative Video Player with useImperativeHan
```
...
> **Predict**: Commit to an answer: does common hooks mastery — usecallback, usememo, useref, useimperativehandle get simpler or harder once usememo enters the picture?
>
...
> **Cloze**: {blank} governs how common hooks mastery — usecallback, usememo, useref, useimperativehandle behaves when multiple usecallback concerns collide.
> **Cloze**: The rule that keeps usememo correct under load is called {blank}.
> **Cloze**: In common hooks mastery — usecallback, usememo, useref, useimperativehandle, <button> determines {blank}.
> **Spot the Mistake**: Code review note: someone applies usecallback everywhere "to be safe" in a common hooks mastery — usecallback, usememo, useref, useimperativehandle codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need usecallback. Apply it where the semantics demand it, and document why.*
