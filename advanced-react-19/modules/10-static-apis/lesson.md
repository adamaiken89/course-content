...
```mermaid
mindmap
  root((React DOM Static APIs prerender renderToStaticNodeStrea))
...
> **Predict**: Commit to an answer: does react dom static apis — prerender, rendertostaticnodestream get simpler or harder once prerender enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies rendertostaticmarkup everywhere "to be safe" in a react dom static apis — prerender, rendertostaticnodestream codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need rendertostaticmarkup. Apply it where the semantics demand it, and document why.*
