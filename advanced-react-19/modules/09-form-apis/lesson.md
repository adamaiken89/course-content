...
```mermaid
mindmap
  root((React 19 Form APIs useFormStatus Server Actions in Form))
...
> **Predict**: Commit to an answer: does react 19 form apis — useformstatus, server actions in forms get simpler or harder once useformstatus enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies <form> everywhere "to be safe" in a react 19 form apis — useformstatus, server actions in forms codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need <form>. Apply it where the semantics demand it, and document why.*
