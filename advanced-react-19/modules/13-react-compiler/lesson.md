...
```mermaid
mindmap
  root((React Compiler Forget Auto Memoization Migration))
    ...
    Migration Strategy Enable Incrementally Test with Stric
...
> **Predict**: Commit to an answer: does react compiler — forget, auto memoization, migration get simpler or harder once // @reactcompiler enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies usememo everywhere "to be safe" in a react compiler — forget, auto memoization, migration codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need usememo. Apply it where the semantics demand it, and document why.*
