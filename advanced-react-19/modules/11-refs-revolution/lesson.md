...
> **Predict**: Commit to an answer: does refs revolution — forwardref deprecated, ref as prop get simpler or harder once forwardref enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies ref everywhere "to be safe" in a refs revolution — forwardref deprecated, ref as prop codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need ref. Apply it where the semantics demand it, and document why.*
