...
flowchart LR
  ...
  AM -->|"想換條魚, 佢唔收"| ES
  Lesson["LESSON: 錢 = 大家都肯收<br/>喺北極, HKD 紙幣 = 廢紙"]
  ES --> Lesson
```

你帶住一疊 HKD 紙幣去北極探險, 愛斯基摩人唔識乜嘢係「HKD」, 佢只係當你張紙係燃料。阿明覺得好屈:「呢疊紙喺香港值一萬蚊喎!」但喺北極, 呢疊紙真係冇用 — 因為冇人肯收。**錢嘅本質, 從來都唔係紙、金、銀, 係人與人之間嘅「共識」**。
...
flowchart TD
  M["錢"]
  M -->|"阿明用 $50 買叉燒飯"| F1["交換媒介"]
  M -->|"叉燒飯 $50, iPhone $9000"| F2["價值尺度"]
  M -->|"今個月儲起 $500 旅行用"| F3["價值儲存"]
```
...
用阿明去日本旅行做例子, 睇下錢喺四個場景入面點樣運作:

**場景 1: 香港茶餐廳** — 阿明坐低叫「我要 $50 叉燒飯」, 拎 $50 紙幣出嚟, 陳太接過, 完成交易。冇人覺得有問題, 因為喺香港, **HKD 係錢** — 人人都肯收。

**場景 2: 北極** — 阿明帶住 $10000 HKD 去北極, 想同愛斯基摩人換條魚。對方接過張紙睇咗一眼, 諗緊「呢張紙我用嚟生火好唔好?」。喺香港值萬金嘅一疊紙, 喺北極一文不值 — **冇共識, 就係廢紙**。

**場景 3: 機場找換店** — 去日本之前, 阿明要去機場找換店, 以 1 HKD = 19 JPY 換咗 190000 日圓。**法幣之間要兌換** — 每個國家只認自己嘅貨幣。

**場景 4: 東京拉麵店** — 阿明喺東京食拉麵, 一碗 1200 JPY, 大約 $63 HKD。如果匯率郁咗 5%, 同一碗拉麵嘅港元成本就唔同 — **匯率會郁, 直接影響購買力**。

**四個場景嘅共通點**: 錢有冇用, 唔係睇張紙本身, 係睇**當時得令嘅人肯唔肯收、收幾多**。
...
| 銀行 | 名義利率 | 複利方式 | 實質 APY |
|:---|---:|:---|---:|
| A 行 | 4.8% APR | 月複利 | **4.92%** |
| B 行 | 4.9% APY | — | 4.90% |

A 行實際高啲 (4.92% > 4.90%) → **揀 A 行**。
...
$100 喺唔同通脹率下嘅購買力 (用 Rule of 72 計):
