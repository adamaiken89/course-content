...
> **Predict**: Commit to an answer: does css modules in react get simpler or harder once *.module.css enters the picture?
>
...
> **Cloze**: {blank} governs how css modules in react behaves when multiple .base concerns collide.
> **Cloze**: The rule that keeps *.module.css correct under load is called {blank}.
> **Cloze**: In css modules in react, .button_base_1a2b3 determines {blank}.
> **Spot the Mistake**: Code review note: someone applies .base everywhere "to be safe" in a css modules in react codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need .base. Apply it where the semantics demand it, and document why.*
