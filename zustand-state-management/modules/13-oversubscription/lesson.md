...
> **Predict**: Commit to an answer: does zustand weakness 1 — over-subscription and debugging get simpler or harder once user.name enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies user everywhere "to be safe" in a zustand weakness 1 — over-subscription and debugging codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need user. Apply it where the semantics demand it, and document why.*
