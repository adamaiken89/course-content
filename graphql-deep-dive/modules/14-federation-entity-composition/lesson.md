...
```mermaid
mindmap
  root((Federation Entity Composition))
    Entities and key
    external Field
    requires Field
    provides Field
...
> **Predict**: Commit to an answer: does federation entity composition get simpler or harder once @key enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies user everywhere "to be safe" in a federation entity composition codebase. Spot the mistake.
>
