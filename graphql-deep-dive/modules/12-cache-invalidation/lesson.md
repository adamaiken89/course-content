...
> **Predict**: Commit to an answer: does cache invalidation get simpler or harder once put /users/1 enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies get /users/1 everywhere "to be safe" in a cache invalidation codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need get /users/1. Apply it where the semantics demand it, and document why.*
