...
mindmap
  root((Observability))
    ...
    Example 1 OTel Instrumentation with Parent-Child Span T
...
> **Predict**: Commit to an answer: does observability get simpler or harder once @redact enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies console.log everywhere "to be safe" in a observability codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need console.log. Apply it where the semantics demand it, and document why.*
