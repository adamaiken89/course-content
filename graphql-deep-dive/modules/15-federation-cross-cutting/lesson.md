...
> **Predict**: Commit to an answer: does federation cross-cutting get simpler or harder once x-user-id enters the picture?
>
...
> **Cloze**: {blank} governs how federation cross-cutting behaves when multiple x-scopes concerns collide.
> **Cloze**: The rule that keeps x-user-id correct under load is called {blank}.
> **Cloze**: In federation cross-cutting, partial determines {blank}.
> **Spot the Mistake**: Code review note: someone applies x-scopes everywhere "to be safe" in a federation cross-cutting codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need x-scopes. Apply it where the semantics demand it, and document why.*
