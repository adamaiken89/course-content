...
> **Predict**: Commit to an answer: does mutations get simpler or harder once input enters the picture?
>
...
> **Spot the Mistake**: Code review note: someone applies @oneof everywhere "to be safe" in a mutations codebase. Spot the mistake.
>
> *Answer: Blanket application hides which spots actually need @oneof. Apply it where the semantics demand it, and document why.*
